  ...
  <main class="shell">
    ...
    <section class="game-layout">
      ...
      <aside>
        ...
        <section class="guide"><div class="eyebrow">A FIELD GUIDE</div><div class="instruction"><span class="instruction-icon">↗</span><div><strong>Lead the way</strong><p>Move your mouse to guide the head. No keyboard steering needed.</p></div></div><div class="instruction"><span class="instruction-icon">⌁</span><div><strong>Save any segment</strong><p>Click and drag any part. Cross your own body safely; every part collects food.</p></div></div><div class="instruction"><span class="instruction-icon warning">3</span><div><strong>Three seconds. Move.</strong><p>Moles appear every second. Blinking ground gives you three seconds to move.</p></div></div><div class="tip">Keep your head in view as the field scrolls right. Your hidden tail is safe from moles.</div></section>
      </aside>
    </section>
